...
The “Productivity” application gives a tool for time management. The user can use the app to create a task list, adding a short description and the estimated number of pomodoros needed for the task. 
